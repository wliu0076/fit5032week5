...
const errors = ref({
  username: null,
  password: null,
  confirmPassword: null, // 新增确认密码错误字段
  resident: null,
  gender: null,
  reason: null
})
...
const validatePassword = (blur) => {
  ...
  const confirmPassword = formData.value.confirmPassword // 获取确认密码字段
  const minLength = 8
    ...
    <div class="row">
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <!-- Password 和 Confirm Password 也放在同一行 -->
          <div class="row mb-3">
            <div class="col-md-6 col-sm-6">
          ...
          <!-- Australian Resident? 和 Reason for joining 保持原样 -->
          <div class="row mb-3">
            <div class="col-md-6 col-sm-6">
